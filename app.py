...
SUB_PATH = os.environ.get('SUB_PATH', 'sub999')           # 订阅token
UUID = os.environ.get('UUID', '2dbb186d-f09a-467e-a847-f1719c673434')  # UUID
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'sikusd.kkkkk.xx.kg')        # Argo固定隧道域名,留空使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiZjM5NGI0ZDA1OThiODJmOTdlOGEyYzE3MTM5NGZjOTYiLCJ0IjoiNTU0MmI1MzAtNDVlMC00ZjE5LTg1NDctNGYzOWZkNThiZWZjIiwicyI6Ik5UazNaamhsTXpFdE5qSmhNaTAwT1dKakxUZzVOall0TWpFNFltSXdNREJtWkRWaCJ9')            # Argo固定隧道token或json,留空使用临时隧道
...
CHAT_ID = os.environ.get('CHAT_ID', '7886284400')                # Telegram chat_id
BOT_TOKEN = os.environ.get('BOT_TOKEN', '7669258945:AAGNTd8625Oy6h3oWN8en1EfDn2ZY0BjpHc')            # Telegram bot_token
